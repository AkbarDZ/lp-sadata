...
/* PLEASE DO NOT COPY AND PASTE THIS CODE. */(function(){var w=window,C='___grecaptcha_cfg',cfg=w[C]=w[C]||{},N='grecaptcha';var gr=w[N]=w[N]||{};gr.ready=gr.ready||function(f){(cfg['fns']=cfg['fns']||[]).push(f);};(cfg['render']=cfg['render']||[]).push('onload');w['__google_recaptcha_client']=true;var d=document,po=d.createElement('script');po.type='text/javascript';po.async=true;po.src='https://www.gstatic.com/recaptcha/releases/v1QHzzN92WdopzN_oD7bUO2P/recaptcha__en.js';var e=d.querySelector('script[nonce]'),n=e&&(e['nonce']||e.getAttribute('nonce'));if(n){po.setAttribute('nonce',n);}var s=d.getElementsByTagName('script')[0];s.parentNode.insertBefore(po, s);})();;
...
if(typeof theme.Account!=='undefined'){theme.Account.initialize()}}).apply(this,[jQuery]);var Tawk_API=Tawk_API||{},Tawk_LoadStart=new Date();(function(){var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];s1.async=!0;s1.src='https://embed.tawk.to/5e60932ec32b5c191739a9e6/default';s1.charset='UTF-8';s1.setAttribute('crossorigin','*');s0.parentNode.insertBefore(s1,s0)})();$(document).ready(function(){$("#formDiscuss").on("submit",(event)=>{event.preventDefault();$.ajax({url:$("#formDiscuss").attr("action"),type:$("#formDiscuss").attr("method"),data:$("#formDiscuss").serializeArray(),beforeSend:()=>{$("#submitDiscuss").attr("disabled",!0).attr("class","btn btn-primary btn-modern disabled").val("Loading ...")},success:(resp)=>{alert("Thanks for contacting us we will be in touch with you shortly");window.location.reload()},error:(resp)=>{$("#submitDiscuss").removeAttr("disabled").attr("class","btn btn-primary btn-modern").val("Send Request");if(typeof resp.responseJSON.data=="object"){Object.keys(resp.responseJSON.data).forEach((key)=>{if(typeof resp.responseJSON.data[key]=="object"){resp.responseJSON.data[key].forEach((value)=>{if(value=="validation.recaptcha"){alert("Please check the captcha form")}else{alert(value)}})}})}}})});$("#formMessage").on("submit",(event)=>{event.preventDefault();$.ajax({url:$("#formMessage").attr("action"),type:$("#formMessage").attr("method"),data:$("#formMessage").serializeArray(),beforeSend:()=>{$("#submitMessage").attr("disabled",!0).attr("class","btn btn-primary btn-modern disabled").val("Loading ...")},success:(resp)=>{alert("Thanks for contacting us we will be in touch with you shortly");window.location.reload()},error:(resp)=>{$("#submitMessage").removeAttr("disabled").attr("class","btn btn-primary btn-modern").val("Send Request");if(typeof resp.responseJSON.data=="object"){Object.keys(resp.responseJSON.data).forEach((key)=>{if(typeof resp.responseJSON.data[key]=="object"){resp.responseJSON.data[key].forEach((value)=>{if(value=="validation.recaptcha"){alert("Please check the captcha form")}else{alert(value)}})}})}}})})});$('.card-click').click(function(e){$('.card-click').removeClass('bg-color-primary-gradient');$('.card-click').find('h4').removeClass('card-text-color-white');$('.card-click').find('p').removeClass('card-text-color-white');$('.card-click').find('i').removeClass('card-active-i');$('.card-click').find('div.col-lg-2').removeClass('card-active-col');$('.img-stack').removeClass('img-stack-active');$(this).addClass('bg-color-primary-gradient');$(this).find('h4').addClass('card-text-color-white');$(this).find('p').addClass('card-text-color-white');$(this).find('i').addClass('card-active-i');$(this).find('div.col-lg-2').addClass('card-active-col');$('#'+$(this).data("img-id")).addClass('img-stack-active')});$(document).ready(function(){$('#card-1').click()})