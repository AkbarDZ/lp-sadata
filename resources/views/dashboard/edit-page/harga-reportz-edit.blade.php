...
<form method="POST" action="{{ route('harga.update_report', $report->id) }}">
    @csrf
    @method('PUT')
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Edit Report</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="colum mb-6">
                                ...
                                <div class="col-lg-14 fv-row">
                                    <input type="text" name="sales_id" id="sales_id" value="{{ $report->sales_id }}"
                            ...
                            <div class="form-group" id="kt_modal_new_address">
                                ...
                                <select id="statusreport_basic" name="statusreport_basic" data-control="select2"
                                    data-dropdown-parent="#kt_modal_new_address" data-placeholder="Status Basic_advance"
                                    class="form-select form-select-solid" required>
                                    <option value="aktif" @if($report->statusreport_basic === 'aktif') selected
                                        @endif>Aktif</option>
                                    <option value="nonaktif" @if($report->statusreport_basic === 'nonaktif') selected
                            ...
                            <div class="form-group" id="kt_modal_new_address">
                                ...
                                <select id="statusreport_advance" name="statusreport_advance" data-control="select2"
                                    data-dropdown-parent="#kt_modal_new_address" data-placeholder="Status Advance"
                                    class="form-select form-select-solid" required>
                                    <option value="aktif" @if($report->statusreport_advance === 'aktif') selected
                                        @endif>Aktif</option>
                                    <option value="nonaktif" @if($report->statusreport_advance === 'nonaktif') selected
                                        @endif>Nonaktif</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group" id="kt_modal_new_address">
                                ...
                                <select id="statusreport_expert" name="statusreport_expert" data-control="select2"
                                    ...
                                    class="form-select form-select-solid" required>
                                    <option value="aktif" @if($report->statusreport_expert === 'aktif') selected
                                        @endif>Aktif</option>
                                    <option value="nonaktif" @if($report->statusreport_expert === 'nonaktif') selected
                                        @endif>Nonaktif</option>
                                </select>
                            </div>
