...
@section('content')
<form method="POST" action="{{ route('beranda.update_mobile', ['id' => $datamobile->id]) }}">
                                ...
                                <div class="colum mb-6">
                                    ...
                                    <div class="col-lg-14 fv-row">
                                        <textarea type="text" maxlength="45"
                                            ...
                                            name="mobiles_title">{{$datamobile->mobiles_title}}</textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                ...
                                <div class="colum mb-6">
                                    ...
                                    <div class="col-lg-14 fv-row">
                                        <textarea type="text" maxlength="145"
                                            class="form-control form-control-solid limitedForm"
                                            name="mobiles_description">{{$datamobile->mobiles_description}}</textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
