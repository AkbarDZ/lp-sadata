                        ...
                        <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
                            <div class="row mx-3 justify-content-between border-bottom pt-4 border-default">
                                ...
                                <div class="card-toolbar d-flex w-150px h-45px px-0 p-1 mb-6 ">
                                    <a href="{{ route('harga.create_general') }}" class="btn btn-sm btn-light-primary">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu " aria-labelledby="dropdownMenuLink">
                                                        <li><a class="dropdown-item fs-6"
                                                                href="{{ route('harga.edit_general', $general->id) }}"><i
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item fs-6" href="#">
                                                                <form method="POST"
                                                                    action="{{ route('harga.destroy_general', $general->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
