                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
                            <div class="row mx-3 justify-content-between border-bottom pt-4 border-default">
                                ...
                                <a href="{{ route('harga.create_attendance') }}"
                                        ...
                                        <tr class="align-top text-left">
                                            ...
                                            <td class="px-0 pm-10">
                                                ...
                                                <span class="text-muted fw-semibold d-block fs-6">
                                                    Status Basic : @if ($attendance->statusbasicc === 'aktif')
                                                    <i class="fa fa-check-circle text-danger"></i>
                                                    @elseif ($attendance->statusbasicc === 'nonaktif')
                                                    <i class="fa fa-times-circle text-danger"></i>
                                                    @endif
                                                </span>
                                                <span class="text-muted fw-semibold d-block fs-7">
                                                    Status Advance : @if ($attendance->statusadvancee === 'aktif')
                                                    <i class="fa fa-check-circle text-danger"></i>
                                                    @elseif ($attendance->statusadvancee === 'nonaktif')
                                                    <i class="fa fa-times-circle text-danger"></i>
                                                    @endif</span>
                                                <span class="text-muted fw-semibold d-block fs-7">
                                                    Status Expert : @if ($attendance->statusexpertt === 'aktif')
                                                    <i class="fa fa-check-circle text-danger"></i>
                                                    @elseif ($attendance->statusexpertt === 'nonaktif')
                                                    <i class="fa fa-times-circle text-danger"></i>
                                                    @endif</span>
                                            </td>
                                            ...
                                            <td class="ps-2 pe-4 pm-10 align-middle">
                                                <div class="d-flex justify-content-center">
                                                    <div class="w-150px d-flex justify-content-evenly">
                                                        <a href="{{ route('harga.edit_attendance', ['id' => $attendance->id]) }}"
                                                            class="btn btn-icon btn-warning"><i class="las la-edit fs-2"></i></a>
                                                        <form action="{{ route('harga.destroy_attendance', ['id' => $attendance->id]) }}" method="POST"
