                        ...
                        <tr class="align-top text-left">
                            ...
                            <td class="px-2 pm-10 ">
                                <div class="d-flex justify-content-center">
                                    <img src="{{ asset('storage/' . $item->feature_image_path) }}" alt="Image" style="max-width: 100px; max-height: 100px;">
                                </div>
                            </td>
                            ...
                            <td class="ps-2 pe-4 pm-10 align-middle">
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="w-150px d-flex justify-content-evenly">
                                        <a href="{{ route('fitur.edit', ['id' => $item->id]) }}" class="btn btn-icon btn-warning"><i class="las la-edit fs-2"></i></a>
                                        <form action="{{ route('fitur.delete', ['id' => $item->id]) }}" method="POST" onsubmit="return confirm('you sure?')">
                                            @csrf
                                            @method('DELETE')
