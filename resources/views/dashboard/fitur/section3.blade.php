...
<div class="row mb-8 mt-8 justify-content-between">
    <h1 style="width: fit-content" class="mb-5">Section 3</h1>
                        ...
                        <tr class="align-top text-left">
                            <td class="ps-4 pe-2 pm-10">
                                <p class="text-dark fw-semibold mb-2 fs-6">
                                    {{ $item->fitur_section_3->title_3 }}
                                </p>
                            </td>

                            <td class="px-2 pm-10">
                                <p class="text-dark fw-semibold mb-2 fs-6">
                                    {{ $item->fitur_section_3->description_3}}
                                </p>
                            </td>

                            <td class="px-2 pm-10">
                                <p class="text-dark fw-semibold mb-2 fs-6">
                                    {{ $item->fitur_section_3->subtitle_3}}
                                </p>
                            </td>

                            <td class="px-2 pm-10">
                                <p class="text-dark fw-semibold mb-2 fs-6">
                                    {{ $item->fitur_section_3->section3_1}}
                                </p>
                            </td>

                            <td class="px-2 pm-10">
                                <p class="text-dark fw-semibold mb-2 fs-6">
                                    {{ $item->fitur_section_3->section3_2}}
                                </p>
                            </td>

                            <td class="px-2 pm-10">
                                <p class="text-dark fw-semibold mb-2 fs-6">
                                    {{ $item->fitur_section_3->section3_3}}
                                </p>
                            </td>
                            ...
                            <td class="ps-2 pe-4 pm-10 align-middle">
                                ...
                                <div class="w-150px d-flex justify-content-evenly">
                                    <a href="{{ route('fitur.edit3', ['id' => $item->id]) }}" class="btn btn-icon btn-warning"><i class="las la-edit fs-2"></i></a>
