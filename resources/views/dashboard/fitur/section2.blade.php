...
<div class="row mb-8 mt-8 justify-content-between">
    <h1 style="width: fit-content" class="mb-5">Section 2</h1>
                ...
                <table id="kt_datatable_zero_configuration_2_nonactive" class="table table-hover border-bottom border-top 
                    ...
                    <thead>
                        <tr class="fw-semibold fs-4">
                            ...
                            <th class="pb-3 pt-0 px-2 w-200px min-w-200px mw-sm-200px">Subtitle
                            </th>
                            <th class="pb-3 pt-0 px-2 w-200px min-w-200px mw-sm-200px">Content 1
                            </th>
                            <th class="pb-3 pt-0 px-2 w-200px min-w-200px mw-sm-200px">Content 2
                            </th>
                            <th class="pb-3 pt-0 px-2 w-200px min-w-200px mw-sm-200px">Content 3
                            </th>
                        ...
                        <tr class="align-top text-left">
                            <td class="ps-4 pe-2 pm-10">
                                <p class="text-dark fw-semibold mb-2 fs-6">
                                    {{ $item->fitur_section_2->title_2 }}
                                </p>
                            </td>

                            <td class="px-2 pm-10">
                                <p class="text-dark fw-semibold mb-2 fs-6">
                                    {{ $item->fitur_section_2->description_2}}
                                </p>
                            </td>

                            <td class="px-2 pm-10">
                                <p class="text-dark fw-semibold mb-2 fs-6">
                                    {{ $item->fitur_section_2->subtitle_2}}
                                </p>
                            </td>

                            <td class="px-2 pm-10">
                                <p class="text-dark fw-semibold mb-2 fs-6">
                                    {{ $item->fitur_section_2->section2_1}}
                                </p>
                            </td>

                            <td class="px-2 pm-10">
                                <p class="text-dark fw-semibold mb-2 fs-6">
                                    {{ $item->fitur_section_2->section2_2}}
                                </p>
                            </td>

                            <td class="px-2 pm-10">
                                <p class="text-dark fw-semibold mb-2 fs-6">
                                    {{ $item->fitur_section_2->section2_3}}
                                </p>
                            </td>
                            ...
                            <td class="ps-2 pe-4 pm-10 align-middle">
                                ...
                                <div class="w-150px d-flex justify-content-evenly">
                                    <a href="{{ route('fitur.edit2', ['id' => $item->id]) }}" class="btn btn-icon btn-warning"><i class="las la-edit fs-2"></i></a>
