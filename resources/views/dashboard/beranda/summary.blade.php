                            ...
                            <td class="ps-2 pe-4 pm-10 align-middle">
                                <div class="d-flex justify-content-center">
                                    <div class="d-flex w-150px justify-content-evenly">
                                        <a href="{{ route('beranda.edit_summary', ['id' => $item->id]) }}" class="btn btn-icon btn-warning"><i class="las la-edit fs-2"></i></a>
                                        <form action="{{ route('beranda.delete_summary', ['id' => $item->id]) }}" method="POST" onsubmit="return confirm('you sure?')">
                                            @csrf
                                            @method('DELETE')
