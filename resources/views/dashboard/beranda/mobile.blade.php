...
<div class="row mb-8 mt-8 justify-content-between">
    <h1 style="width: fit-content" class="mb-5">Beranda - Mobiles</h1>
    <div class="d-flex gap-4 w-700px justify-content-start justify-content-md-end flex-wrap">
        <form method="post" id="upload-excel" action="/produk/import_excel" enctype="multipart/form-data">
            @csrf
            <a href="{{ route('beranda.create_mobile') }}"
                ...
                <table id="kt_datatable_zero_configuration_2_nonactive" class="table table-hover border-bottom border-top 
                    ...
                    <thead>
                        <tr class="fw-semibold fs-4">
                            <th class="pb-3 ps-4 pt-0 w-200px min-w-200px mw-sm-200px">Mobiles Title
                            </th>
                            <th class="pb-3 pt-0 px-2 w-200px min-w-200px mw-sm-200px">Mobiles Descriptions
                            </th>
                            ...
                            <td class="ps-2 pe-4 pm-10 align-middle">                         
                                <div class="d-flex justify-content-center">
                                    <div class="d-flex w-150px justify-content-evenly">
                                        <a href="{{ route('beranda.edit_mobile', ['id' => $item->id]) }}" class="btn btn-icon btn-warning"><i class="las la-edit fs-2"></i></a>
                                        <form action="{{ route('beranda.delete_mobile', ['id' => $item->id]) }}" method="POST" onsubmit="return confirm('you sure?')">
                                            @csrf
                                            @method('DELETE')
